...
public partial class SettingsPage : Page
{
    ...
    private async void BtnTestAlarm_Click(object sender, RoutedEventArgs e)
    {
        try
        {
            TxtTestAlarmStatus.Foreground = (Microsoft.UI.Xaml.Media.Brush)Application.Current.Resources["TextFillColorSecondaryBrush"];
            TxtTestAlarmStatus.Text = "Генерация тестовой тревоги...";
            ...
            var testAlarm = new AlarmEvent
            {
                ...
                Description = $"ТЕСТОВАЯ ТРЕВОГА: Падение давления в контуре ниже 0.8 бар! [{DateTime.Now:HH:mm:ss}]",
                EventType = "Alarm",
            ...
            TxtTestAlarmStatus.Foreground = (Microsoft.UI.Xaml.Media.Brush)Application.Current.Resources["SystemFillColorSuccessBrush"];
            TxtTestAlarmStatus.Text = $"Тестовая тревога #{testAlarm.Id} успешно создана в {DateTime.Now:HH:mm:ss}!";
        ...
        {
            TxtTestAlarmStatus.Foreground = (Microsoft.UI.Xaml.Media.Brush)Application.Current.Resources["SystemFillColorCriticalBrush"];
            TxtTestAlarmStatus.Text = $"Ошибка: {ex.Message}";
        }
    }
}
